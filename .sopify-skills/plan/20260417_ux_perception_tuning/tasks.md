...
- [ ] B.1 修正 `runtime/router.py:_is_consultation()` 的问句+动作词判断
...
- [ ] B.2 修正 `runtime/router.py:_estimate_complexity()` 的 complex 默认降级
