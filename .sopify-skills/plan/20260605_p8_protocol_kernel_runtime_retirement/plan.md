...
- **Status**: W1 完成 / W2 进行中（W2.0a-W2.7 done，W2.8 next）
- **Next**: W2.8 — Delete runtime gate / default runtime entry / bundle legacy scripts
- **Task**: W2.8 删 scripts/runtime_gate.py + scripts/sopify_runtime.py + check-bundle-smoke.sh，然后串行 W2.9 → ...
