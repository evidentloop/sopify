"""Minimal YAML loader for Sopify catalog generation.

Supports only the subset used by skill.yaml front matter: nested mappings,
lists, booleans, integers, strings, and comments.

This is a read-only loader — no dump/write functionality is included.
The writer portion (dump_yaml) was part of runtime/_yaml.py and was used
only by the plan registry, which is retired in P8.
"""
