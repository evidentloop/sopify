...
from ._resume import CheckpointRequestError, validate_develop_resume_context
...
class StateStore:
    ...
    def get_current_run(self) -> Optional[RunState]:
        payload = read_json(self.current_run_path)
    ...
    def set_current_run(self, run_state: RunState) -> None:
        ...
        write_json(self.current_run_path, payload)
    ...
    def get_last_route(self) -> Optional[RouteDecision]:
        payload = read_json(self.last_route_path)
    ...
    def get_current_clarification(self) -> Optional[ClarificationState]:
        payload = read_json(self.current_clarification_path)
    ...
    def get_current_decision(self) -> Optional[DecisionState]:
        payload = read_json(self.current_decision_path)
