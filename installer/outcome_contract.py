...
PRIMARY_CODE_MISSING_BUNDLE = "missing_bundle"
...
PRIMARY_CODE_PAYLOAD_MANIFEST_NOT_FOUND = "payload_manifest_not_found"
...
PRIMARY_CODE_INGRESS_PROOF_GATE_ENTER_OBSERVED = "ingress_proof_gate_enter_observed"
PRIMARY_CODE_INGRESS_PROOF_DIRECT_ENTRY_BLOCK_OBSERVED = "ingress_proof_direct_entry_block_observed"
PRIMARY_CODE_INGRESS_PROOF_MISSING = "ingress_proof_missing"
PRIMARY_CODE_INGRESS_PROOF_STALE = "ingress_proof_stale"
PRIMARY_CODE_INGRESS_PROOF_UNREADABLE = "ingress_proof_unreadable"
...
_PRIMARY_CODE_BY_REASON = {
    ...
    "MISSING_BUNDLE": PRIMARY_CODE_MISSING_BUNDLE,
    ...
    "PAYLOAD_MANIFEST_NOT_FOUND": PRIMARY_CODE_PAYLOAD_MANIFEST_NOT_FOUND,
    ...
    "INGRESS_PROOF_GATE_ENTER_OBSERVED": PRIMARY_CODE_INGRESS_PROOF_GATE_ENTER_OBSERVED,
    "INGRESS_PROOF_DIRECT_ENTRY_BLOCK_OBSERVED": PRIMARY_CODE_INGRESS_PROOF_DIRECT_ENTRY_BLOCK_OBSERVED,
    "INGRESS_PROOF_MISSING": PRIMARY_CODE_INGRESS_PROOF_MISSING,
    "INGRESS_PROOF_STALE": PRIMARY_CODE_INGRESS_PROOF_STALE,
    "INGRESS_PROOF_UNREADABLE": PRIMARY_CODE_INGRESS_PROOF_UNREADABLE,
}

_ACTION_LEVEL_BY_PRIMARY = {
    PRIMARY_CODE_STUB_SELECTED: ACTION_CONTINUE,
    PRIMARY_CODE_STUB_INVALID: ACTION_FAIL_CLOSED,
    PRIMARY_CODE_MISSING_BUNDLE: ACTION_FAIL_CLOSED,
    ...
    PRIMARY_CODE_PAYLOAD_MANIFEST_NOT_FOUND: ACTION_WARN,
    ...
    PRIMARY_CODE_INGRESS_PROOF_GATE_ENTER_OBSERVED: ACTION_CONTINUE,
    PRIMARY_CODE_INGRESS_PROOF_DIRECT_ENTRY_BLOCK_OBSERVED: ACTION_WARN,
    PRIMARY_CODE_INGRESS_PROOF_MISSING: ACTION_WARN,
    PRIMARY_CODE_INGRESS_PROOF_STALE: ACTION_WARN,
    PRIMARY_CODE_INGRESS_PROOF_UNREADABLE: ACTION_WARN,
}
