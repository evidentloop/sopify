...
- **Status**: Wave 1–3 与 Task 4.0 已完成；EvidentLoop `v0.1.0a2` 已公开发布，当前分发契约漂移已收口。
- **Next**: 等待用户审计 Task 4.0；确认前不进入 Wave 4.1 的可选安装实现。
- **Task**: 11/21。
...
- [ ] Wave 4–6、公开版本 dogfood 和归档完成。

## Next

等待用户审计 Task 4.0；确认前不进入 Wave 4.1 的 `--with-evidentloop` 实现。
