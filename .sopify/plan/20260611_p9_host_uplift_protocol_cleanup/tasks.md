...
- [ ] **W1.4a** Qoder rules precedence / override check：显式验证 `.qoder/rules/` 与 AGENTS.md 的优先级覆盖关系（`scripts/w33_qoder_proof.py:48` 已声明此风险），记录 rules 覆盖是否导致协议入口被绕过，产出 evidence 进 `assets/w1_gaps.md`
