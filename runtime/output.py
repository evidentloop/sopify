...
_LABELS = {
    "zh-CN": {
        ...
        "exec_handoff": "已检测到活动 plan，自动进入执行恢复入口",
        ...
        "next_exec": "当前有活动 plan，使用 ~go 自动恢复执行；普通开发流继续按宿主会话推进",
    ...
    "en-US": {
        ...
        "exec_handoff": "Active plan detected; auto-routing to execution recovery",
        ...
        "next_exec": "An active plan exists; use ~go to auto-resume execution; otherwise continue through the host flow",
